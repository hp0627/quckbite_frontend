      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-orange-500 hover:text-orange-600 transition-colors duration-300">
              QuickBite
            </h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="text-gray-600 hover:text-gray-700 transition-colors duration-300">
          ...
          {/* Social Links */}
          <div className="space-y-4">
            <h4 className="text-lg font-semibold text-gray-700">Follow Us</h4>
